...
func main() {
	...
	flag.BoolVar(&kiroLogin, "kiro-login", false, "Login to Kiro using OAuth")
	flag.BoolVar(&kiroLogin, "kiro-aws-login", false, "Login to Kiro using OAuth (AWS Builder ID)")
	flag.BoolVar(&kiroLogin, "kiro-google-login", false, "Login to Kiro using OAuth (Google)")
	flag.BoolVar(&kiroLogin, "kiro-github-login", false, "Login to Kiro using OAuth (Gith)")
