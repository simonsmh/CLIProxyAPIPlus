...
func TestIsOneShotCommandMode(t *testing.T) {
	tests := []struct {
		...
		{name: "kiro social login", opts: commandModeOptions{kiroLogin: true}, want: true},
		{name: "kiro github alias login", opts: commandModeOptions{kiroGitHubLogin: true}, want: true},
